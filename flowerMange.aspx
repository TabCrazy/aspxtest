<%@ Page Language="C#" AutoEventWireup="true" CodeFile="flowerMange.aspx.cs" Inherits="flowerMange" %>
                ...
                <div class="cont-box">
                    <div class="list-filter-bar">
                        ...
                        <div class="inpu">
                            ...
                            <asp:DropDownList runat="server" class="selectsty small" ID="drp2" AutoPostBack="true" OnTextChanged="drp2_TextChanged">
                                <asp:ListItem Value="0">全部</asp:ListItem>
                            </asp:DropDownList>

                            <asp:Button runat="server" ID="btn_query" OnClick="btn_query_Click" CssClass="filter" Visible="false" Text="查询" />
                        </div>
                        <a href="./addFlower.aspx">添加鲜花</a>
                    </div>
                            ...
                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                <HeaderTemplate>
                                    <tr class="table-row head">
                                        ...
                                        <td class="table-col sname">名称
                                        </td>
                                        <td class="table-col pic">图片
                                        </td>
                                        <td class="table-col spec">规格(支/扎)
                                        </td>
                                ...
                                <ItemTemplate>
                                    <tr class="table-row">
                                        ...
                                        <td class="table-col sname">
                                            <%#Eval("mc")%>
                                        </td>
                                        <td class="table-col pic">
                                            <asp:Image runat="server" ImageUrl='<%#"~\\img" + "\\" +Eval("tp")%>' Width="100" Height="80" />
                                        </td>
                                        <td class="table-col spec">
                                            <%#Eval("gg")%>
                                        </td>
